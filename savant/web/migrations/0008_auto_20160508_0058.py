...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='site',
            options={'ordering': ('chain_id', 'name')},
        ),
        migrations.AlterModelOptions(
            name='zone',
